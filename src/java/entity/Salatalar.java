...
public class Salatalar {
    ...
    public Salatalar(int id,String yemek_adi,String tarif,String malzemeler,int kac_kisilik,int hazirlama_sure,int pisirme_sure,int sef){
        this.id = id;
